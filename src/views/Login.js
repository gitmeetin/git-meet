    ...
    <div className="root" {...rest}>
      <div className="main-container">
        <div className="containerfluid">
          <div className="landing-page-container">
            <div className="content__wrapper">
              ...
              <p className="coords" style={{ color: '#6699CC' }}>
              ...
              <div className="scroller" style={{ color: '#6699CC' }}>
        ...
        <div className="features-container">
          <div className="features slide">
            <div className="text-container">
              <div className="intro-text" style={{ color: '#6699CC' }}>
        ...
        <div className="contribute slide">
          <div className="img-container" style={{ color: '#6699CC' }}>
        ...
        <div className="copyright" style={{ color: '#6699CC' }}>
